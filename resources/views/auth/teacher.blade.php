...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ secure_asset('assets/modules/bootstrap-social/bootstrap-social.css') }}">
                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="login-brand">
                            <img src="{{ secure_asset('assets/img/logo.png') }}" alt="logo" width="100" class="">
                        </div>

                        <div class="card card-primary">
                            <div class="card-body">
                                <form method="POST" action="/auth/wali-kelas/login" class="needs-validation" novalidate="">
                                    @csrf()
                                    <div class="form-group">
                                        <label for="nip">NIP</label>
                                        <input id="nip" type="number" class="form-control" name="nip" tabindex="1" required autofocus>
                                    </div>
