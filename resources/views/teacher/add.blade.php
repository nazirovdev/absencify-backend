            ...
            <form class="card-body" action="/wali-kelas/tambah" method="POST" enctype="multipart/form-data">
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan NIP Wali Kelas" name="nip" value="{{ old('nip') }}" type="number">
                            @error('nip')
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Nama Wali Kelas" name="nama" value="{{ old('nama') }}" type="text">
                            @error('nama')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                ...
                <div>
                    <div class="form-group row mb-4">
                        ...
                        <input class="form-control" placeholder="Masukkan Alamat Wali Kelas" name="alamat" value="{{ old('alamat') }}" type="text">
                        @error('alamat')
                        <span style="font-style: italic; color: red; font-weight: bold;">
                            {{ $message }}
                        </span>
