...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            @endif
            <div class="card">
                <form class="card-body" action="/wali-kelas/edit/{{ $teacher->id }}" method="POST"
                    ...
                    <div>
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Alamat Wali Kelas" name="alamat"
                                value="{{ $teacher->alamat }}" type="text">
                            @error('alamat')
                                <span style="font-style: italic; color: red; font-weight: bold;">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="col-sm-12 p-0">
                            <label
                                ...
                                <img style="display: block; width: 100%; height: 100%;object-fit: cover"
                                    src="{{ $teacher->image == null ? asset('assets/img/default.jpg') : asset('storage/teacher/' . $teacher->image) }}"
                                    class="img-upld" />
