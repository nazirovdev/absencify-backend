...
<body>
    ...
    <table border="1" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td style="padding: 5px; text-align: center; font-weight: bold">No</td>
            <td style="width: 555px; text-align: center; padding: 5px; font-weight: bold">
                Nama
            </td>
        </tr>
        @foreach ($classrooms as $classroom)
            <tr>
                ...
                <td style="width: 555px; text-align: center; padding: 5px">
                    {{ $classroom->nama }}
                </td>
            </tr>
        @endforeach
