                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control input-nis-siswa" placeholder="Masukkan NIS Siswa"
                                    name="nis_siswa" value="{{ $student->nis }}" type="number">
                                @error('nis_siswa')
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control" placeholder="Masukkan Alamat" name="alamat_siswa"
                                    value="{{ $student->alamat }}" type="text">
                                @error('alamat_siswa')
                                    <span style="font-style: italic; color: red; font-weight: bold;">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control" placeholder="Masukkan Alamat" name="telepon_siswa"
                                    value="{{ $student->telepon }}" type="text">
                                @error('telepon_siswa')
                                    <span style="font-style: italic; color: red; font-weight: bold;">
                                        {{ $message }}
                                    </span>
                        ...
                        <div class="col-sm-12 p-0">
                            <label
                                ...
                                <img style="display: block; width: 100%; height: 100%;object-fit: cover"
                                    src="{{ $student->image == null ? asset('assets/img/default.jpg') : asset('storage/student/' . $student->image) }}"
                                    class="img-upld" />
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control input-nama-wali-siswa" placeholder="Masukkan Nama Wali Siswa"
                                    name="nama_wali_siswa" value="{{ $student->guardian->nama }}" type="text">
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control input-username-wali-siswa"
                                    ...
                                    value="{{ $student->guardian->username }}" type="text">
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control input-nama-wali-siswa" placeholder="Masukkan Alamat Wali Siswa"
                                    name="alamat_wali_siswa" value="{{ $student->guardian->alamat }}" type="text">
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control input-username-wali-siswa"
                                    ...
                                    value="{{ $student->guardian->telepon }}" type="text">
