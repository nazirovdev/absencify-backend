                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control input-nis-siswa" placeholder="Masukkan NIS Siswa" name="nis_siswa" value="{{ old('nis_siswa') }}" type="number">
                            @error('nis_siswa')
                    ...
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Nama Siswa" name="nama_siswa" value="{{ old('nama_siswa') }}" type="text">
                            @error('nama_siswa')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Alamat" name="alamat_siswa" value="{{ old('alamat_siswa') }}" type="text">
                            @error('alamat_siswa')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Alamat" name="telepon_siswa" value="{{ old('telepon_siswa') }}" type="text">
                            @error('telepon_siswa')
                            <span style="font-style: italic; color: red; font-weight: bold;">
                                {{ $message }}
                            </span>
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control input-nama-wali-siswa" placeholder="Masukkan Nama Wali Siswa" name="nama_wali_siswa" value="{{ old('nama_wali_siswa') }}" type="text">
                    ...
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control input-username-wali-siswa" placeholder="Masukkan Username Wali Siswa" name="username_wali_siswa" value="{{ old('username_wali_siswa') }}" type="text">
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control input-nama-wali-siswa" placeholder="Masukkan Alamat Wali Siswa" name="alamat_wali_siswa" value="{{ old('alamat_wali_siswa') }}" type="text">
                    ...
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control input-username-wali-siswa" placeholder="Masukkan Telepon Wali Siswa" name="telepon_wali_siswa" value="{{ old('telepon_wali_siswa') }}" type="text">
