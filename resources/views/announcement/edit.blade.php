                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control" placeholder="Masukkan Judul Pengumuman" name="judul"
                                    value="{{ $announcement->judul }}" type="text">
                                @error('judul')
                        ...
                        <div class="col">
                            <div class="form-group row mb-4">
                                ...
                                <input class="form-control" placeholder="Masukkan Tanggal Publikasi" name="tanggal_publikasi"
                                    value="{{ $announcement->tanggal_publikasi }}" type="date">
                            ...
                            <div class="col-sm-12 p-0">
                                <label
                                    ...
                                    <img style="display: block; width: 100%; height: 100%;object-fit: cover"
                                        src="{{ $announcement->lampiran == null ? asset('assets/img/default.jpg') : asset('storage/lampiran/'.$announcement->lampiran) }}" class="img-lampiran" />
