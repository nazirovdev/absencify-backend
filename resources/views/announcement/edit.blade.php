...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <div class="card">
            <form class="card-body" action="/pengumuman/edit/{{ $announcement->id }}" method="POST" enctype="multipart/form-data">
                @csrf()
                @method('PUT')
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Judul Pengumuman" name="judul" value="{{ $announcement->judul }}" type="text">
                            @error('judul')
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Tanggal Publikasi" name="tanggal_publikasi" value="{{ $announcement->tanggal_publikasi }}" type="date">
                ...
                <div>
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 p-0">
                            <label style="width: 200px; height: 230px;border-width: 2px; border-color: gray; border-style: dashed; padding: 3px" for="lampiran">
                                <img style="display: block; width: 100%; height: 100%;object-fit: cover" src="{{ $announcement->lampiran == null ? secure_asset('assets/img/default.jpg') : secure_asset('storage/lampiran/'.$announcement->lampiran) }}" class="img-lampiran" />
                                <input type="file" name="lampiran" id="lampiran" style="display: none" class="input-upld">
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group row mb-4">
                    ...
                    <div class="col-12 p-0">
                        <textarea class="summernote-simple" style="display: none;" name="isi_pengumuman">
