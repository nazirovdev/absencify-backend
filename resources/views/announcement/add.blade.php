                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Judul Pengumuman" name="judul" value="{{ old('judul') }}" type="text">
                            @error('judul')
                ...
                <div class="row gx-5" style="gap: 40px">
                    <div class="col">
                        <div class="form-group row mb-4">
                            ...
                            <input class="form-control" placeholder="Masukkan Tanggal Publikasi" name="tanggal_publikasi" value="{{ old('tanggal_publikasi') }}" type="date">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 p-0">
                            <label style="width: 200px; height: 230px;border-width: 2px; border-color: gray; border-style: dashed; padding: 3px" for="lampiran">
                                <img style="display: block; width: 100%; height: 100%;object-fit: cover" src="{{ secure_asset('assets/img/default.jpg') }}" class="img-lampiran" />
